                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="graph-day-selection float-right" role="group">
                      ...
                      <a href="add-searchadvertisement.php"
                        type="button"
                        class="btn active">Add Advertisement</a>
                    </div>
                  </div>
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table products-table" class="table table-hover" data-toggle="table"  data-url="api-firebase/get-bootstrap-table-data.php?table=searchadvertisement" data-page-list="[5, 10, 20, 50, 100, 200]" data-show-refresh="false" data-show-columns="false" data-side-pagination="server" data-pagination="true" data-search="true" data-trim-on-search="false" data-filter-control="true" data-query-params="queryParams" data-sort-name="id" data-sort-order="desc" data-show-export="false" data-export-types='["txt","excel"]' data-export-options='{
